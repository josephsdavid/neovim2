...
require("luasnip.loaders.from_vscode").load({ paths = { "/home/david/.config/nvim/lua/user/snips" } }) -- Load snippets from my-snippets folder
...
--require("luasnip.loaders.from_snipmate").load({ path = { "/home/david/.config/nvim/lua/user/vim-snippets/snippets" } }) -- Load snippets from my-snippets folder
