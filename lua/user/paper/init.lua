-- Neovim Color File
-- Name:            ???
-- Maintainer:      josephsdavid
-- License:         The MIT License (MIT)
-- Based On:        https://github.com/romgrk/doom-one.vim and the original Doom Emacs one, and https://github.com/NTBBloodbath

-- Helpers {{{

local paper = {}

local utils = require("user.paper.utils")
local colors = require("user.paper.colors")

local config = {
	ui = {
		cursor_coloring = vim.g.paper_cursor_coloring or false,
		terminal_colors = vim.g.paper_terminal_colors or true,
		italic_comments = vim.g.paper_italic_comments or false,
		enable_treesitter = vim.g.paper_enable_treesitter or true,
		diagnostics_text_color = vim.g.paper_diagnostics_text_color or false,
		transparent_background = vim.g.paper_transparent_background or false,
		pumblend = {
			enable = vim.g.paper_pumblend_enable or false,
			transparency_amount = vim.g.paper_pumblend_transparency or 20,
		},
	},
	plugins = {
		neorg = vim.g.paper_plugin_neorg or true,
		barbar = vim.g.paper_plugin_barbar or false,
		telescope = vim.g.paper_plugin_telescope or false,
		neogit = vim.g.paper_plugin_neogit or true,
		nvim_tree = vim.g.paper_plugin_nvim_tree or true,
		dashboard = vim.g.paper_plugin_dashboard or true,
		startify = vim.g.paper_plugin_startify or true,
		whichkey = vim.g.paper_plugin_whichkey or true,
		indent_blankline = vim.g.paper_plugin_indent_blankline or true,
		vim_illuminate = vim.g.paper_plugin_vim_illuminate or true,
		lspsaga = vim.g.paper_plugin_lspsaga or false,
	},
}
...
paper.set_colorscheme = function()
	-- Set UI options
	------------------
