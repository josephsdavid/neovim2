...
M.setup = function()
  ...
  local on_attach = function(client, bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", Keys.go("D"),
      "<cmd>lua require('goto-preview').goto_preview_definition()<cr>", opts)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", Keys.go("l"),
