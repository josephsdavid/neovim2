...
local map_table = {
	...
	leader = { -- mappings such as leader-w, leader then single key
		leader = Keys.leader,
    name = "leader",
		opts = { noremap = true, silent = true },
		maps = {
	...
	docs = { -- mappings to leader docsleader
	...
	hop = { -- mappings to leader hopleader
	...
	zepl = { -- mappings to leader zeplleader
	...
	norg = { -- mappings to buffer leader
	...
	telescope = { -- mappings to buffer leader
		leader = Keys.telescopeleader,
    name = "telescope",
		opts = { noremap = true, silent = true },
		maps = {
			[{ "n", "f" }] ={ "<cmd>lua require('telescope.builtin').find_files(require('telescope.themes').get_dropdown{previewer = false})<cr>", "find files"},
			[{ "n", "g" }] ={ "<cmd>Telescope live_grep theme=ivy<cr>", "Live grep"},
			[{ "n", "b" }] ={ "<cmd>lua require('telescope.builtin').buffers(require('telescope.themes').get_dropdown{previewer = false})<cr>", "find buffers"},
			...
			[{ "n", "D" }] ={ "<cmd>lua require('telescope.builtin').lsp_type_definitions()<cr>", "find lsp type definitions"},
			[{ "n", "t" }] ={ "<cmd>lua require('telescope.builtin').treesitter()<cr>", "treesitter magic"},
		},
	},

	harpoon = { -- mappings to buffer leader
