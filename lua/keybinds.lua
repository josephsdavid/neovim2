...
local map_table = {
	...
	telescope = { -- mappings to telescope leader
		...
		maps = {
			...
			[{ "n", "w" }] = { ":lua require('telescope').extensions.git_worktree.git_worktrees()", "switch git worktrees" },
			[{ "n", "W" }] = { ":lua require('telescope').extensions.git_worktree.create_git_worktree()", "create git worktrees" },
