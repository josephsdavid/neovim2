...
M.n = {
    ...
    [scope("d")] = { cmd("Telescope diagnostics theme=ivy"), "find lsp definitions" },
    ...
    [Alt("f")] = { cmd("FzfLua fzf_colors=true"), "fzf" },
    [scope("r")] = { cmd("FzfLua resume fzf_colors=true"), "fzf resume" },
