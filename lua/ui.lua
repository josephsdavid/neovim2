...
Mappings.keymap("n", Mappings.leader("mm"), markfn(hm.add_file), "harpoon mark")
Mappings.keymap("n", Mappings.leader("me"), markfn(require('harpoon.cmd-ui').toggle_quick_menu), "harpoon menu")
